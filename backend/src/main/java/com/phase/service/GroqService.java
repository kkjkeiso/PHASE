...
/* Serviço de integração com a API Groq — chat e transcrição de áudio */
@Service
public class GroqService {

    private static final Logger log = LoggerFactory.getLogger(GroqService.class);

    /* Prompt do sistema — define o comportamento pedagógico da PHASE */
    private static final String SYSTEM_PROMPT = """
            Você é PHASE (Plataforma Heurística de Avaliação, Suporte e Educação), \
    ...
    /* Envia mensagem de texto para a API Groq */
    public String chat(String userMessage) {
        return chat(userMessage, null);
    }

    /* Envia mensagem com imagem opcional para a API Groq */
    ...
    /* Resposta fallback quando a API key não está configurada */
